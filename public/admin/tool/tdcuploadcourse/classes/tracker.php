 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_tdcuploadcourse_tracker {
    ...
    public function results($total, $created, $updated, $deleted, $errors) {
        ...
        $message = array(
            get_string('coursestotal', 'tool_tdcuploadcourse', $total),
            get_string('coursescreated', 'tool_tdcuploadcourse', $created),
            get_string('coursesupdated', 'tool_tdcuploadcourse', $updated),
            get_string('coursesdeleted', 'tool_tdcuploadcourse', $deleted),
            get_string('courseserrors', 'tool_tdcuploadcourse', $errors)
        );
    ...
    public function start() {
        ...
        if ($this->outputmode == self::OUTPUT_PLAIN) {
            ...
            echo html_writer::start_tag('table', ['class' => 'table generaltable',
                'summary' => get_string('uploadcoursesresult', 'tool_tdcuploadcourse')]);
            echo html_writer::start_tag('tr', array('class' => 'heading r' . $this->rownb));
            echo html_writer::tag('th', get_string('csvline', 'tool_tdcuploadcourse'),
                array('class' => 'c' . $ci++, 'scope' => 'col'));
            echo html_writer::tag('th', get_string('result', 'tool_tdcuploadcourse'), array('class' => 'c' . $ci++, 'scope' => 'col'));
            echo html_writer::tag('th', get_string('id', 'tool_tdcuploadcourse'), array('class' => 'c' . $ci++, 'scope' => 'col'));
