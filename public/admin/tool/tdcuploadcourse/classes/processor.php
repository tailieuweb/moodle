 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_tdcuploadcourse_processor {
     ...
     * Execute the process.
     *
     * @param tool_tdcuploadcourse_tracker $tracker the output tracker to use.
     * @return void
     */
    public function execute($tracker = null) {
        ...
        if (empty($tracker)) {
            $tracker = new tool_tdcuploadcourse_tracker(tool_tdcuploadcourse_tracker::NO_OUTPUT);
        }
        $tracker->start();
     ...
     * @return tool_tdcuploadcourse_course
     */
    protected function get_course($data) {
        ...
        return new tool_tdcuploadcourse_course($this->mode, $this->updatemode, $data, $this->defaults, $importoptions);
    }
    ...
    protected function get_restore_content_dir() {
        ...
        $dir = tool_tdcuploadcourse_helper::get_restore_content_dir($backupfile, $shortname);
        return $dir;
    }
