...
final class processor_test extends \advanced_testcase {
    ...
    public function test_basic(): void {
        ...
        $options = array('mode' => tool_tdcuploadcourse_processor::MODE_CREATE_ALL);
        $defaults = array('category' => '1');

        $p = new tool_tdcuploadcourse_processor($cir, $options, $defaults);
    ...
    public function test_restore_template_course(): void {
        ...
        $options = array('mode' => tool_tdcuploadcourse_processor::MODE_CREATE_NEW, 'templatecourse' => $c1->shortname);
        $defaults = array('category' => '1');
    ...
    public function test_shortname_template(): void {
        ...
        $options = array('mode' => tool_tdcuploadcourse_processor::MODE_CREATE_NEW, 'shortnametemplate' => '%i: %f');
        $defaults = array('category' => '1');
    ...
    public function test_empty_csv(): void {
        ...
        $p = new tool_tdcuploadcourse_processor($cir, $options, array());
    }
