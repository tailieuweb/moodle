...
use tool_tdcuploadcourse_processor;
use tool_tdcuploadcourse_course;

/**
 * Course test case.
 *
 * @covers     \tool_tdcuploadcourse_course
...
final class course_test extends \advanced_testcase {
    ...
    public function test_proceed_without_prepare(): void {
        ...
        $mode = tool_tdcuploadcourse_processor::MODE_CREATE_NEW;
        $updatemode = tool_tdcuploadcourse_processor::UPDATE_NOTHING;
        $data = array();
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data);
    ...
    public function test_invalid_shortname_too_long(): void {
        ...
        $upload = new tool_tdcuploadcourse_course($mode, $updatemode, [
            'category' => 1,
            'fullname' => 'New course',
    ...
    public function test_invalid_role(): void {
        ...
        foreach ($roles as $role) {
            ...
            if (in_array($role->archetype, $rolesallowed)) {
                ...
                $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, [], $importoptions);
                $this->assertTrue($co->prepare());
                $co->proceed();
            } else {
                $this->assertFalse($co->prepare());
    ...
    public function test_delete(): void {
        ...
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, array(), $importoptions);
        $this->assertFalse($co->prepare());
    ...
    public function test_update(): void {
        ...
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, $defaults);
        $this->assertTrue($co->prepare());
        $co->proceed();
    ...
    public function test_default_data_saved(): void {
        ...
        $this->assertFalse($DB->record_exists('course', array('shortname' => 'c1')));
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, $defaultdata);
        $this->assertTrue($co->prepare());
        $co->proceed();
        $this->assertTrue($DB->record_exists('course', array('shortname' => 'c1')));
        $course = $DB->get_record('course', array('shortname' => 'c1'));
    ...
    public function test_rename(): void {
        ...
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, $defaultdata, $importoptions);
        $this->assertTrue($co->prepare());
        $co->proceed();
    ...
    public function test_reset(): void {
        ...
        $importoptions = array('canreset' => true);
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, array('reset' => 1), $importoptions);
        $this->assertTrue($co->prepare());
        $co->proceed();
        $this->assertTrue($DB->record_exists('groups', array('id' => $g1->id)));
        $this->assertTrue($DB->record_exists('groups_members', array('groupid' => $g1->id, 'userid' => $u1->id)));
    ...
    public function test_enrolment_error_create_course(string $expectederror, array $uploaddata): void {
        ...
        $upload = new tool_tdcuploadcourse_course($mode, $updatemode, array_merge($uploaddata, [
            'category' => $category->id,
            'fullname' => 'My course',
        ]));
        ...
        $this->assertEquals(get_string($expectederror, 'tool_tdcuploadcourse', 'Manual enrolments'),
    ...
    public function test_enrolment_error_update_course(string $expectederror, array $uploaddata): void {
        ...
        $upload = new tool_tdcuploadcourse_course($mode, $updatemode, $uploaddata);
    ...
    public function test_custom_fields_data(): void {
        ...
        $uploader = new tool_tdcuploadcourse_course($mode, $updatemode, $dataupload);
    ...
    public function test_custom_fields_data_required(): void {
        ...
        $uploader = new tool_tdcuploadcourse_course($mode, $updatemode, $dataupload, $defaults);
        $this->assertTrue($uploader->prepare());
        $uploader->proceed();
    ...
    public function test_idnumber_problems(): void {
        ...
        $data = array('shortname' => $c1->shortname, 'idnumber' => $c1->idnumber, 'summary' => 'S', 'fullname' => 'F',
            'category' => 1);
        $co = new tool_tdcuploadcourse_course($mode, $updatemode, $data, array(), array());
        $this->assertTrue($co->prepare());
     ...
     *
     * @covers \tool_tdcuploadcourse_course::prepare
     */
     ...
     *
     * @covers \tool_tdcuploadcourse_course::proceed
     */
