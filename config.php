...
$CFG->dbhost    = 'web-mysql';              // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodle_513';                 // database name, eg moodle
$CFG->dbuser    = 'web';               // your database username
$CFG->dbpass    = 'web';               // your database password
